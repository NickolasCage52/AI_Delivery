...
const SEGMENTS = [
  ...
  {
    label: "B",
    title: "Локальный бизнес в Москве и СПб",
  ...
  {
    label: "D",
    title: "Оптовые продажи и дистрибуция",
...
const NOT_FOR = `Кому не подходит: если нет конкретной задачи или процесса — мы не берёмся. Работаем под измеримый результат.`;
  ...
  return (
    <section id="who-fits" className="relative py-24 md:py-32 bg-[var(--bg-secondary)]/40">
      <Container>
        ...
        >
          Кому подходит автоматизация бизнеса
        </motion.h2>
